...
export default class ListStudentAttendance extends Component {
  ...
  ExportExel=()=>{
    ...
    var dataTable = '<table> <tbody><tr> <th>Column One</th> <th>Column Two</th> <th>Column Three</th> </tr> <tr> <td>row1 Col1</td> <td>row1 Col2</td> <td>row1 Col3</td> </tr> <tr> <td>row2 Col1</td> <td>row2 Col2</td> <td>row2 Col3</td> </tr> </tbody></table>';
    console.log('ddaay laf ham tesst ');
    window.open('data:application/vnd.ms-excel,' + dataTable);
    e.preventDefault();
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={this.ExportExel}
          >
            <Text style={styles.buttonText}>IN FILE EXCEL</Text>
          </TouchableOpacity>
        </View>
