        ...
        return (
            <View style={styles.scrollViewContent}>
                <View style={styles.row}>
                    ...
                    <Text style={{paddingHorizontal:20,color:'black',opacity:.8}}>{this.state.userData.email}</Text>
                </View>
                <View style={styles.row}>
                    <Image source={mssv} style={{height:30,width:30,}}/> 
                    <Text style={{paddingHorizontal:20,color:'black',opacity:.8}}>{this.state.userData.MSGV}</Text>
                </View>
                <View style={styles.row}>
                    <Image source={name} style={{height:30,width:30,}}/> 
                    <Text style={{paddingHorizontal:20,color:'black',opacity:.8}}>{this.state.userData.fullName}</Text>
                </View>
                <View style={styles.row}>
                    <Image source={address} style={{height:30,width:30,}}/> 
                    <Text style={{paddingHorizontal:20,color:'black',opacity:.8}}>{this.state.userData.address}</Text>
                </View>
                <View style={styles.row}>
                    <Image source={birthday} style={{height:30,width:30,}}/> 
                    <Text style={{paddingHorizontal:20,color:'black',opacity:.8}}>{this.state.userData.dateBirthday}</Text>
                </View>
                <View style={styles.row}>
                    <Image source={phone} style={{height:30,width:30,}}/> 
                    {/* <TouchableOpacity onPress={this.makeCall}> */}
                        <Text style={{paddingHorizontal:20,color:'blue',opacity:.8}}>{this.state.userData.numberPhone}</Text>
                     {/* </TouchableOpacity> */}
                </View>
                <View style={styles.row}>
                    <Image source={sex} style={{height:30,width:30,}}/> 
                    <Text style={{paddingHorizontal:20,color:'black',opacity:.8}}>{this.state.userData.sex}</Text>
                </View>
            </View>
        );
    }
